...
const container = document.querySelector(".random-text-container");
function removeContent(){
  container.innerText="";
}
function ganerateRandomText(){
  removeContent();
  let paraRqst = input.value-1;
  let content = text.slice(0,paraRqst).join(" ");

  container.innerText=content;
}

generateButton.addEventListener("click",ganerateRandomText);